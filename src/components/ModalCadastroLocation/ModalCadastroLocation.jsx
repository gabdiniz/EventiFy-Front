...
export function ModalCadastroLocation({ show, handleClose, tonavigate, listarLocalizacoes}) {
    ...
    function clearFormFields() {
        formLocation.setValue("cep", null);
        formLocation.setValue("uf", "");
        formLocation.setValue("cidade", "");
        formLocation.setValue("bairro", "");
        formLocation.setValue("endereco", "");
        formLocation.setValue("name", "");
        formLocation.setValue("complemento", null);
    }
    ...
    useEffect(() => {
        if (submitted) {
            ...
            setSubmitted(false);
            handleClose();
            navigate(`${tonavigate}`, { state: { cadastrouLocation: true } })
            ;
        }
